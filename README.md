# PayWeb_Magento_2
## PayGate Magento plugin v2.4.1 for Magento v2.4.3
...
Please navigate to the [releases page](https://github.com/PayGate/PayWeb_Magento_2/releases), download the latest release (v2.4.1) and unzip. You will then be able to follow the integration guide PDF which is included in the zip.
